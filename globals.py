...
def initialize(): 
    ...
    global dt,tmax,N1,N2,netY,netZ,model,springModel
    global rho,ux,uy,uz
    ...
    N2=30                       # number of particles along z (edges not included) | USE EVEN NUMBER
    ...
    ux,uy,uz=1.5,0.0,0.0        # [m/s] fluid velocity
    ...
    m[0,::int((N2+2)/16)]=0.46  # 16 heavier nodes
